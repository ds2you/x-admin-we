    ...
    <el-card>
      <el-table :data="userList" stripe style="width: 100%">
        ...
        <el-table-column  label="操作"  width="180">
            <template  slot-scope="scope" >
               <el-button @click="openEditUI(scope.row.id)"   type="primary" icon="el-ciomn-deit"  size="mini" circle></el-button>
               <el-button @click="deleteUser(scope.row)"    type="danger" icon="el-ciomn-delete" size="mini" circle></el-button>
            </template>
        </el-table-column>
      </el-table>
    </el-card>
...
<el-dialog @close="clearForm"   :title="title" :visible.sync="dialogFormVisible">
  <el-form :model="userForm" ref="userFormRef"    :rules="rules">
    ...
    <el-form-item  v-if="userForm.id == null || userForm.id == undefined" 
      label="登陆密码"
      prop="password" :label-width="formLabelWidth">
